...
from stable_baselines import logger, deepq_kpi
...
from stable_baselines.deepq_kpi.replay_buffer import ReplayBuffer, PrioritizedReplayBuffer
from stable_baselines.deepq_kpi.policies import DQNPolicy
